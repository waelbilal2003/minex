...
class PostCardWidgetSearch extends StatefulWidget {
  final Map<String, dynamic> post;
  final VoidCallback? onDelete;

  const PostCardWidgetSearch({Key? key, required this.post, this.onDelete})
      : super(key: key);

  @override
  _PostCardWidgetSearch createState() => _PostCardWidgetSearch();
}

class _PostCardWidgetSearch extends State<PostCardWidgetSearch> {
  @override
  void initState() {
    super.initState();
    // لا ننسخ القيم هنا — نعتمد على widget.post مباشرة في العرض
  }
