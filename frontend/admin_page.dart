                ...
                if (ad['media_files'] != null &&
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemCount: (ad['media_files'] as List).length,
                      itemBuilder: (context, index) {
                        String relativePath = ad['media_files'][index];
                        // ✅ تحويل المسار النسبي إلى رابط كامل
                        String fullUrl = '${AuthService.baseUrl}/$relativePath';
                        bool isVideo = relativePath.endsWith('.mp4') ||
                            relativePath.endsWith('.mov') ||
                            relativePath.endsWith('.avi');
